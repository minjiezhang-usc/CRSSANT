...
if len(sys.argv) < 6:
    print("\nUsage:  python  gapfilter.py  annotation  insam  outsam  idloc  short  gaptype\n"
...
print(str(datetime.now())[:-7]+'\t'+"Started " + gaptype + " filter analysis"+'\n')
...
print("                        Total alignments:", inputcount)
